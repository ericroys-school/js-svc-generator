...
describe("SVG Builder tests", () => {
  ...
  describe("All the build methods", () => {
    ...
    it("Should build svg with square and text", ()=> {
        ...
        let d = `<svg height="300" width="200" xmlns="http://www.w3.org/2000/svg"> <rect x="0" y="0" height="200" width="200" stroke="orange" stroke-width="2" fill="blue"/> <text x="100" y="100" dominant-baseline="middle" text-anchor="middle" fill="blue" stroke="orange" stroke-width="2" font-size="60">BOB</text></svg>`
        expect(s.build()).toEqual(d);
    })
    ...
    it("Should build svg with circle with text", ()=> {
        ...
        let d = `<svg height="300" width="200" xmlns="http://www.w3.org/2000/svg"> <circle r="100" cx="100" cy="100" fill="blue" stroke="orange" stroke-width="2"/> <text x="100" y="100" dominant-baseline="middle" text-anchor="middle" fill="blue" stroke="orange" stroke-width="2" font-size="60">BOB</text></svg>`
        expect(s.build()).toEqual(d);
    })    
    it("Should build svg with triangle, no text", ()=> {
        ...
        .shapeBorderColor("orange")
        .shapeColor("blue");
        let d = `<svg height="300" width="200" xmlns="http://www.w3.org/2000/svg"> <path d="M100 4 L4 200 L196 200 Z" stroke="orange" stroke-width="2" fill="blue"/> </svg>`
        expect(s.build()).toEqual(d);
    })
    it("Should build svg with triangle with text", ()=> {
        ...
        console.log(s.build())
        let d = `<svg height="300" width="200" xmlns="http://www.w3.org/2000/svg"> <path d="M100 4 L4 200 L196 200 Z" stroke="orange" stroke-width="2" fill="blue"/> <text x="100" y="100" dominant-baseline="middle" text-anchor="middle" fill="blue" stroke="orange" stroke-width="2" font-size="60">BOB</text></svg>`
        expect(s.build()).toEqual(d);
    })
  });
});

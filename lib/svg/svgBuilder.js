...
export class SVGBuilder {
  ...
  textBorder(width) {
    if (width && !isNaN(width)) this.#txtb = width;
    return this;
  }
  textFontSize(size) {
    if (size && !isNaN(size)) this.#txtF = size;
    return this;
  }

  /**
   * 
   * @returns an svg built from parameters passed into the builder
   * note: due to `this` weirdness in JS this is not following the 
   * Builder design pattern fully :-(
   */
  build() {
    //need shape
